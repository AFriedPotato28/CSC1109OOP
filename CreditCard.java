...
public class CreditCard {
     ...
     */
    public boolean cashAdvanceWithdrawal(double withdrawalAmount) {
        ...
        double cashAdvanceFee = Math.max(minCashAdvanceFee, 0.05 * withdrawalAmount); // cash advance fee set at 5% of
